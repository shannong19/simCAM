...
Instructions for using the code and reproducing figures is available at [https://github.com/shannong19/simCAM/blob/master/figure_production/figures-am-cm.pdf](https://github.com/shannong19/simCAM/figure_production/figures-am-cm.pdf).
